...
import {
    getTeacherShortlists, selectTeacherShortlists, selectShortlistsStatus
...
export default function Messages() {
    ...
    const shortlists = useSelector(selectTeacherShortlists);
    ...
    useEffect(() => {
        if (currentUser) {
            dispatch(getTeacherShortlists(currentUser)).then(response => {
