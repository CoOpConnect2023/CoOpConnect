...
import {
    getStudentShortlists, selectStudentShortlists, selectShortlistsStatus
...
export default function Messages() {
    ...
    const shortlists = useSelector(selectStudentShortlists);
    ...
    useEffect(() => {
        if (currentUser) {
            dispatch(getStudentShortlists(currentUser)).then(response => {
...
console.log("studentlists",shortlists)
